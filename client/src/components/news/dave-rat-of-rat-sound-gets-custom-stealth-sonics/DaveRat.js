...
import myImage from '../../../assets/image/ratty-600x464.jpg';
import myImage2 from '../../../assets/image/ratty2.png';

class  DaveRat extends Component {
            ...
            <article>
                <div id="time" style={{paddingTop:"90px"}}>
                    ...
                    <p style={{fontSize:"50px", marginTop:"20px", fontFamily:'Georgia, serif;'}}>
                        <h4>Super excited to deliver Dave Rat @ratsound his custom impressions!</h4>
                    </p>
<br/><br/>

                    <div id="image" >
                        <img src={myImage2} style={{width:"300px"}} />
